...
public class ViewEmployeesFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtEmployees.setBackground(new java.awt.Color(204, 204, 255));
        ...
        jScrollPane3.setViewportView(jtEmployees);
    ...
    private void loadEmployeesDetails() {
        try
      {
       List<EmployeePojo> emp=EmployeeDAO.getAllEmployeeDetails();
       DefaultTableModel model=(DefaultTableModel)jtEmployees.getModel();
